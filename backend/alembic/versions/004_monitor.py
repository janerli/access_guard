...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("target_type", postgresql.ENUM(name="audit_target_type", create_type=False), nullable=False),
        sa.Column("target_id", sa.String(255), nullable=False, server_default=sa.text("''")),
        sa.Column("operation", postgresql.ENUM(name="audit_operation", create_type=False), nullable=False),
        sa.Column("module", postgresql.ENUM(name="audit_module", create_type=False), nullable=False),
        sa.Column("result", postgresql.ENUM(name="audit_result", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM(name="outbox_status", create_type=False), nullable=False, server_default=sa.text("'pending'::outbox_status")),
    ...
    op.create_table(
        ...
        sa.Column("condition_type", postgresql.ENUM(name="alert_condition_type", create_type=False), nullable=False),
        ...
        sa.Column("data_source", postgresql.ENUM(name="alert_data_source", create_type=False), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column("severity", postgresql.ENUM(name="alert_severity", create_type=False), nullable=False),
        sa.Column("status", postgresql.ENUM(name="alert_status", create_type=False), nullable=False, server_default=sa.text("'new'::alert_status")),
        sa.Column("correlation_id", postgresql.UUID(as_uuid=True), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("code", sa.String(100), nullable=False),
        sa.Column("type", postgresql.ENUM(name="notification_channel_type", create_type=False), nullable=False),
